...
namespace Agriculture_Service_Center
{
    public partial class Frm_Update_Supplier : Form
    {
        ...
        private void Frm_Update_Supplier_Load(object sender, EventArgs e)
        {
            Control_Disabled();
        }
        ...
        private void btn_Search_Click(object sender, EventArgs e)
        {
            if ( tb_S_ID.Text != "")
            {
                ...
                SqlCommand cmd = new SqlCommand("Select * from  Supplier_Table where Supplier_Id = " + tb_S_ID.Text + " ", GFobj.con);
        ...
        private void Btn_Update_Click(object sender, EventArgs e)
        {
            ...
            {
                GFobj.Update_Table("Update Supplier_Table set Date = '" + dtp_S_Date.Text + "', Name = '" + tb_S_Name.Text + "', Address = '" + tb_S_Address.Text + "', Mobile_No = " + tb_S_Mobile.Text + ",Email_Id = '" + tb_S_Email.Text + "',Aadhar_No = " + tb_Aadhar_No.Text + " where Supplier_Id = " + tb_S_ID.Text + " ");
